"""
Django settings for slipher project.
...
SECRET_KEY = 'django-insecure-z2b)2hmpupb%bob49-1(qlzoejfrt&wiuteqw!-#13192o8*-f'
...
WSGI_APPLICATION = 'slipher.wsgi.application'
